...
function ProjectCards() {
    return (
        <React.Fragment>
            ...
            <Card modal_id="intrameet_modal" image_dir="website_pic/intrameet.jpg" title="Cse Department Intrameet" link="http://cseintrameet.epizy.com" frontend="HTML5, CSS3, Bootstrap" backend="PHP, SQL, MySQL" year="2019"/>
            <Card modal_id="sparkle_modal" image_dir="website_pic/sparkle.jpg" title="Sparkle Team Website" link="http://sparkle-best6.epizy.com" frontend="HTML5, CSS3, Bootstrap" year="2019"/>
