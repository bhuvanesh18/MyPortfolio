...
function ProjectModals() {
    return (
        <React.Fragment>
            ...
            <Modal modal_id="intrameet_modal"  project_name="Cse Department Intrameet" link="http://cseintrameet.epizy.com" description="This website is used by my department's official intrameet registration website."/>
            <Modal modal_id="sparkle_modal" project_name="Sparkle Team Website" link="http://sparkle-best6.epizy.com" description="This website is created for my sparkle team, to motivate my team members to got the third price."/>
